      ...
      <div className='text-center max-w-3xl w-full'>
        ...
        {isAuthenticated ? (
          <form
            ...
            className='flex flex-col sm:flex-row gap-3 mb-10 w-full max-w-3xl mx-auto'
          >
            <input
              type='url'
              required
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 text-left mt-16 border-t border-slate-200 dark:border-slate-800 pt-16'>
          <div className='p-2'>
            ...
            <p className='text-slate-600 dark:text-slate-400 text-sm leading-relaxed'>
              Instantly create short, memorable links that look professional in
              any context.
            </p>
          </div>
          ...
          <div className='p-2'>
            ...
            <p className='text-slate-600 dark:text-slate-400 text-sm leading-relaxed'>
              Track performance with minimal distraction. Everything you need,
              nothing you don't.
            </p>
          </div>
          ...
          <div className='p-2'>
            ...
            <p className='text-slate-600 dark:text-slate-400 text-sm leading-relaxed'>
              Built on a solid, secure architecture to ensure your links always
              resolve correctly.
            </p>
          </div>
        </div>
